      ...
      <div className="py-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-darkGreenSavia mb-4">{t('benefits_title_text')}</h2>
            <p className="text-lg text-greySavia">{t('benefits_sub_text')}</p>
          </div>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-darkGreenSavia">{t('benefits1_title_text')}</h3>
                </div>
                <p className="grow max-w-md text-sm text-greySavia">{t('benefits1_sub_text')}</p>
              </div>
              <figure>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-darkGreenSavia">{t('benefits2_title_text')}</h3>
                </div>
                <p className="grow max-w-md text-sm text-greySavia">{t('benefits2_sub_text')}</p>
              </div>
              <figure>
            ...
            <article className="flex flex-col border border-transparent [background:linear-gradient(theme(colors.white),theme(colors.zinc.50))_padding-box,linear-gradient(120deg,theme(colors.zinc.300),theme(colors.zinc.100),theme(colors.zinc.300))_border-box] rounded-lg">
              <div className="grow flex flex-col p-5 pt-6">
                <div className="flex items-center space-x-3 mb-1">
                  ...
                  <h3 className="font-inter-tight font-semibold text-darkGreenSavia">{t('benefits3_title_text')}</h3>
                </div>
                <p className="grow max-w-md text-sm text-greySavia">{t('benefits3_sub_text')}</p>
              </div>
              <figure>
