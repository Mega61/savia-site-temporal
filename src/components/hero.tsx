          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center pb-12 md:pb-16">
              <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-greySavia via-darkGreenSavia to-greySavia pb-4">
                {t('hero_begin_text')} <em className="italic relative inline-flex justify-center items-center text-greenSavia"> {t('hero_highlight_text')}
                  <svg className="absolute fill-darkGreenSavia w-[calc(100%+1rem)] -z-10 top-11" xmlns="http://www.w3.org/2000/svg" width="120" height="10" viewBox="0 0 120 10" aria-hidden="true" preserveAspectRatio="none">
              ...
              <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                <div>
                  <Link className="btn text-zinc-100 bg-darkGreenSavia hover:bg-greenSavia w-full shadow" href="/request-demo">{t('request_demo_btn')}</Link>
                </div>
                {/* <div>
