        ...
        <div className="px-4 sm:px-6">
          <div className="max-w-3xl mx-auto">
              <div className="text-center pb-12 md:pb-16">
                <h1 className="font-inter-tight text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-greySavia via-darkGreenSavia to-greySavia pb-4">
                  The robust <em className="italic relative inline-flex justify-center items-center text-greenSavia"> OMS platform
                    <svg className="absolute fill-darkGreenSavia w-[calc(100%+1rem)] -z-10" xmlns="http://www.w3.org/2000/svg" width="223" height="62" viewBox="0 0 223 62" aria-hidden="true" preserveAspectRatio="none">
                  ...
                  </em> designed to streamline your omnichannel operations
                </h1>
                <p className="text-lg text-greySavia mb-8">
                Overcome inventory challenges, manage multi-source orders, and ensure data consistency across systems, delivering a seamless and efficient customer experience
                </p>
                <div className="max-w-xs mx-auto sm:max-w-none sm:inline-flex sm:justify-center space-y-4 sm:space-y-0 sm:space-x-4">
                  <div>
                    <Link className="btn text-zinc-100 bg-darkGreenSavia hover:bg-zinc-800 w-full shadow" href="/request-demo">Request Demo</Link>
                  </div>
                  {/* <div>
