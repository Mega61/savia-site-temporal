      ...
      <div className="py-12 md:py-20">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="relative max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <h2 className="font-inter-tight text-3xl md:text-4xl font-bold text-zinc-900 mb-4">Streamline your operations <em className="relative not-italic inline-flex justify-center items-end"> today
            ...
            <p className="text-lg text-zinc-500 mb-8">Savia bridges the gap for small businesses, growing teams, and enterprises alike. Ready to transform your order management?</p>
